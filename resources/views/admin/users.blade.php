...
@section('admin_dash_container')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <iframe frameborder="0" height = "700" style="overflow:scroll; width: 100%" src="{{url('allusers')}}" marginheight="1" marginwidth="1" name="cboxmain" id="cboxmain" seamless="seamless" scrolling="" frameborder="0" allowtransparency="true"></iframe>
        </div>
    </div>
@endsection
